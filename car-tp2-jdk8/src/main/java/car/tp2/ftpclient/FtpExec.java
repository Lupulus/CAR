...
import car.tp2.config.Configuration;
...
public  class FtpExec {
	 ...
	 * Une {@link FTPRequestAction} est ajout�e en premier de la liste des fonctions �
	 * ex�cuter lors de l'appel � {@link #execute()}, qui se cherge de la connexion
	 * au serveur FTP.
	 */
	public FtpExec() {
		addAction((exec) -> {
