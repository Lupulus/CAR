...
public class ContentBean {
	 ...
	 */
	public long addShoppingCartContent(Content content) {
	 ...
	 * @return une instance suivi par le gestionnaire d'entité, de l'élément de panier d'achat.
	 */
	public Content create(Content scc) {
	 ...
	 */
	public List<Content> getAllFromShoppingCart(long scId) {
	 ...
	 */
	public Content getFromShoppingCartAndBookId(long scId, long bId) {
